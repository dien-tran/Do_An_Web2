        ...
        ?>
                ...
                <div class="content">
                    <div class="details">
                        ...
                        <?php echo "<br>"; ?>
                        <div class="info">
                            <div class="label"><p style="font-size: 15px; color:black"> Publisher: <b ><?php echo $product['Publisher']; ?></b> </p> 
                            <div class="label"><p style="font-size: 15px; color:black">Author: <b><?php echo $product['MainAuthor']; ?> </b></p></div>
                        </div>

                        <div class="info" >
                            <div class="label"><p style="font-size: 15px; color:black">Languge:<b> <?php echo $product['Language']; ?></b> </p> </div>
                            <div class="label"><p style="font-size: 15px; color:black">Cover Type:<b> <?php echo $product['CoverType']; ?></b> </p></div>
                        </div>
                        
                        <div class="qty-pri" style="width: 100px">
                            <div class="price" style="font-size: 15px">
                                <div class="label"><p style="font-size: 15px; color:black">Price: <b> $<?php echo $product['Price']; ?></b> </p></div>
                            </div>
                        </div>
